...
\begin{figure}[htpb]
    ...
    \begin{tikzcd}
        &  &                                    & S \\
\forall N \arrow[rrru, "\forall f"', bend left] \arrow[rrrd, "\forall g", bend right] \arrow[rr, "\exists ! \varphi" description] &  & M \arrow[ru, "p"'] \arrow[rd, "q"] &   \\
        &  &                                    & T
\end{tikzcd}
    \caption{（外）直积}
...
\forall N &  & M \arrow[ll, "\exists ! \psi" description] &                                                         \\
